import CardDataConfigs from './CardDataConfigs'
import React, { useState } from 'react';
import './Card.css';

const CardListConfigs = () => {
  const [hoveredButton, setHoveredButton] = useState(null);

  return (
    <div className="container">
      <div className="row justify-content-center align-items-center">
        {CardDataConfigs.map((card, index) => (
          <div key={index} className="col-lg-3 col-md-4 col-12 my-3">
            <div className="card card-mobile align-items-center">
              ...
              <div className="card-line">
              <p className="card-text-price">{card.price1} <p className="card-text-price2">liberado em 1 PC</p> </p>
              </div>

              <div className="card-line">
                <p className="card-text-price">{card.price2} <p className="card-text-price2">liberado em 2 PC</p> </p>
              </div>
...
export default CardListConfigs;